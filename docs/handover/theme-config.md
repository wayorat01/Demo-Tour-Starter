...
flowchart TB
    ...
    TC --> CSS
    CSS --> NB1 & NB3 & NB4 & NB5 & WN5
    CSS --> FT1
    HD -->|"designVersion"| NB1 & NB3 & NB4 & NB5 & WN5
...
erDiagram
    THEME_CONFIG {
        string id PK
        group typography
        string bodyFont "select: inter, prompt, kanit..."
...
sequenceDiagram
    ...
    Admin->>CMS: เลือก Body Font = "prompt"
    Admin->>CMS: เลือก Heading Font = "kanit"
...
flowchart TD
    ...
    C --> D["--background: hsl(...)"]
    C --> E["--primary: hsl(...)"]
    C --> F["--font-body: prompt"]
    C --> G["--font-heading: kanit"]
    C --> H["--radius: 0.6rem"]
...
| `src/globals/Header/navbar/wowtour_navbar5.tsx` | WowTour navbar |
