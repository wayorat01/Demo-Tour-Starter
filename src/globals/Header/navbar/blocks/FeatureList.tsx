    ...
    <div className="grid w-full gap-y-12 lg:gap-y-6">
      {title && (
        <div className="border-border text-left lg:border-b lg:pb-3">
          <strong
            className="text-left text-xs font-medium tracking-wider uppercase"
        ...
        {features?.map((feature, index) => (
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-sm font-medium" style={{ color: 'inherit', opacity: 0.85 }}>
                {feature.title}
              </div>
              {feature.description && (
                <p className="mt-1 text-xs" style={{ color: 'inherit', opacity: 0.6 }}>
                  {feature.description}
                </p>
              )}
            </div>
