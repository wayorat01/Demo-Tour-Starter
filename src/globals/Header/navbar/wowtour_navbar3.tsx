import { Clock, Phone, Home, Headphones } from 'lucide-react'
...
import './wowtour_navbar3.css'

// Social media icon SVGs (circle style)
const socialIcons: Record<string, React.ReactNode> = {
  ...
  instagram: (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <circle cx="12" cy="12" r="12" fill="url(#ig3)" />
      <rect
        x="6.5"
        y="6.5"
        width="11"
  ...
  twitter: (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path
        d="M15.9 5.5h2.3l-5 5.7 5.9 7.8h-4.6l-3.6-4.7-4.1 4.7H4.5l5.3-6.1L4.2 5.5h4.7l3.3 4.3 3.7-4.3zm-.8 12.1h1.3L8.9 6.8H7.5l7.6 10.8z"
        fill="white"
      />
    </svg>
  ),
  whatsapp: (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path
        d="M16.4 14.1c-.3-.1-1.6-.8-1.8-.9-.2-.1-.4-.1-.6.1-.2.3-.7.9-.8 1-.2.2-.3.2-.5.1-.3-.1-1.1-.4-2.2-1.3-.8-.7-1.3-1.6-1.5-1.8-.2-.3 0-.4.1-.5.1-.1.3-.3.4-.5.1-.2.2-.3.3-.4.1-.2 0-.3 0-.5s-.6-1.4-.8-2c-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.3-.2.3-.9.9-.9 2.2s1 2.5 1.1 2.7c.1.2 1.9 2.9 4.6 4 .6.3 1.1.4 1.5.6.6.2 1.2.2 1.7.1.5-.1 1.6-.6 1.8-1.3.2-.6.2-1.1.2-1.3-.1-.1-.3-.2-.5-.3z"
        fill="white"
      />
    </svg>
  ),
...
export const Navbar3WowTour: React.FC<{
  header: HeaderType
  ...
  return (
    <>
      <div className="wowtour-navbar3-topbar-wrapper bg-background">
        {/* ===== Top Bar (Desktop only) ===== */}
        <section className="z-50">
          {/* Top gradient bar (curved) */}
          <div className="wowtour-navbar3-gradient-top">
            <div className="wowtour-navbar3-gradient-top-left" />
            <div className="wowtour-navbar3-gradient-top-right" />
          </div>
          <div className="wowtour-navbar3-topbar">
            <div className="container">
              <div className="wowtour-navbar3-topbar-inner">
                {/* Left: Logo */}
                <CMSLink publicContext={publicContext} url={'/'} className="wowtour-navbar3-logo">
                ...
                {showBusinessHours && companyInfo?.businessHours && (
                  <div className="wowtour-navbar3-hours">
                    <div className="wowtour-navbar3-hours-icon">
                      <Clock />
                    </div>
                    <div className="wowtour-navbar3-hours-text">
                      <span className="wowtour-navbar3-hours-label">เวลาทำการ</span>
                      <span className="wowtour-navbar3-hours-value">
                ...
                <div className="wowtour-navbar3-right">
                  {/* Hotline */}
                  {showContacts && companyInfo?.callCenter && (
                    <a
                      href={`tel:${companyInfo.callCenter.replace(/[^0-9+]/g, '')}`}
                      className="wowtour-navbar3-hotline"
                    >
                      <div className="wowtour-navbar3-hotline-icon">
                        <Phone className="h-5 w-5" />
                      </div>
                      <div className="wowtour-navbar3-hotline-text">
                        <span className="wowtour-navbar3-hotline-label">Hotline</span>
                        <span className="wowtour-navbar3-hotline-number">
                  ...
                  {showSocialIcons && socialLinks.length > 0 && (
                    <div className="wowtour-navbar3-socials">
                      {socialLinks.map((social: any, idx: number) => {
                        ...
                        return (
                          <a
                            ...
                            className="wowtour-navbar3-social-icon"
      ...
      {/* ===== Navigation Bar (Grey) — sticky on scroll ===== */}
      <StickyNavDetector className="wowtour-navbar3-sticky">
        <div className="wowtour-navbar3-nav">
          <div className="container">
            <NavActiveMarker>
              <nav className="wowtour-navbar3-nav-inner">
                {/* Home icon */}
                <CMSLink
                  publicContext={publicContext}
                  url={'/'}
                  className="wowtour-navbar3-home-link"
                >
                        ...
                        if (item.blockType === 'link') {
                          return (
                            <CMSLink
                              ...
                              key={item.id}
                              {...item.link}
                              className="wowtour-navbar3-nav-link"
                            />
                          )
                        } else if ((item as { blockType?: string }).blockType === 'sub') {
                          return (
                            <NavigationMenuItem key={item.id}>
                              <NavigationMenuTrigger className="wowtour-navbar3-nav-link">
                          ...
                          if (isCompact) {
                            return (
                              ...
                              >
                                <button className="wowtour-navbar3-nav-link">
                                  {'icon' in item && item.icon && (
