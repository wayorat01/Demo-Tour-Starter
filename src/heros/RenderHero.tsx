...
import { WowtourHeroBanner1 } from '@/heros/PageHero/wowtour_heroBanner1'
import { WowtourHeroBanner2 } from '@/heros/PageHero/wowtour_heroBanner2'
import { WowtourHeroBanner3 } from '@/heros/PageHero/wowtour_heroBanner3'
import { WowtourHeroBanner4 } from '@/heros/PageHero/wowtour_heroBanner4'

import { WowtourBanner1 } from '@/heros/PageHero/wowtour_heroBannerStaticPage2'
import { WowtourHeroBannerStaticPage1 } from '@/heros/PageHero/wowtour_heroBannerStaticPage1'
...
const heroes = {
  ...
  wowtour_heroBannerStaticPage2: WowtourBanner1,
  wowtour_heroBannerStaticPage1: WowtourHeroBannerStaticPage1,
}
...
> = async (props) => {
  ...
  // SSR fetch: ดึง pageConfig + searchOptions ให้ HeroBanner client components ไม่ต้อง fetch ซ้ำ
