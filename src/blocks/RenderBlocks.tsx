...
import { BannerSlideBlock } from './BannerSlide/Component'
import { WowtourPopularCountryBlock } from './PopularCountry/Component'
import { WowtourSearchTourBlock } from './SearchTour/Component'
import { WowtourTourTypeBlock } from './TourType/Component'
import { WowtourGalleryAlbumBlock } from './GalleryAlbum/Component'
import { WowtourBlogCardBlock } from './BlogCard/Component'
import { WowtourBlogListingBlock } from './BlogListing/Component'
import { WowtourGalleryListingBlock } from './GalleryListing/Component'
import { WowtourPromotionCardBlock } from './PromotionCard/Component'
import { StaticContentBlockComponent } from './StaticContent/Component'
import { TourGroupBlockComponent } from './TourGroup/Component'
import { WowtourVisaListBlock } from './VisaList/Component'
import { WowtourFestivalTourBlock } from './Festival/Component'
import { WowtourProductCardBlock } from './ProductCard/Component'
...
const blockComponents: Partial<Record<Page['layout'][0]['blockType'], React.FC<any>>> = {
  ...
  login: LoginBlock,
  signup: SignupBlock,
  bannerSlide: BannerSlideBlock,
  wowtourPopularCountry: WowtourPopularCountryBlock,
  wowtourSearchTour: WowtourSearchTourBlock,
  wowtourTourType: WowtourTourTypeBlock,
  wowtourGalleryAlbum: WowtourGalleryAlbumBlock,
  wowtourBlogCard: WowtourBlogCardBlock,
  wowtourBlogListing: WowtourBlogListingBlock,
  wowtourGalleryListing: WowtourGalleryListingBlock,
  wowtourPromotionCard: WowtourPromotionCardBlock,
  staticContent: StaticContentBlockComponent,
  wowtourTourGroup: TourGroupBlockComponent,
  wowtourVisaList: WowtourVisaListBlock,
  wowtourFestivalTour: WowtourFestivalTourBlock,
  wowtourProductCard: WowtourProductCardBlock,
}
