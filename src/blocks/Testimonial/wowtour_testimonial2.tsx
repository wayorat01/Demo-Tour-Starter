...
/**
 * Testimonial 20 — "Grid Cards Carousel"
 * 3 cards per slide on desktop, 1 on mobile. Auto-slide.
 */
...
const WowtourTestimonial2: React.FC<
      ...
      <div className="container">
        ...
        <div className="relative">
          <Carousel
            ...
            className="w-full"
          >
            <CarouselContent className="-ml-3 px-1 py-2 md:-ml-4">
              {items.map((item) => {
                const interTour =
                ...
                return (
                  ...
                  >
                    <div className="bg-card border-border/50 flex h-full flex-col rounded-2xl border p-6 shadow-sm">
                      <QuoteIcon />
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {item.tourName && (
                            <p className="text-muted-foreground text-xs">{item.tourName}</p>
                          )}
                        </div>
                      </div>
                    </div>
...
export default WowtourTestimonial2
